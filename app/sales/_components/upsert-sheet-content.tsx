...
const UpsertSheetContent = ({products, productsOptions}: UpsertSheetContentProps) => {
    ...
    const onSubmit = (data:FormSchema) => {
        ...
        setSelectedProducts((currecyProducts) => {
            const existingProduct = currecyProducts.find(product => product.id === selectedProduct.id);
            if(existingProduct) {
                ...
                <form className="py-6 space-y-6" onSubmit={form.handleSubmit(onSubmit)}>
                    <FormField
                        ...
                        <FormItem className="w-full">
                          ...
                          <FormControl>
                            <Combobox options={productsOptions} placeholder="Selecione um produto" { ...field }/>
                          </FormControl>
                          {/* <Combobox
                            value={field.value}
